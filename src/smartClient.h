   /***********************************************************************************
    Copyright (C) 2021 Phil Bowles, based heavily upon (=copied!) work by:
    <Bob Lemaire, IoTaWatt, Inc.>
...
class smartClient: public AsyncClient {
  ...
  struct  URL {
    ...
    typedef std::function<void(void*, smartClient*, int readyState)> readyStateChangeCB;
    typedef std::function<void(void*, smartClient*, size_t available)> onDataCB;
  ...
  public:
    ...
    bool    open(const char* , const char* URL);        // Initiate a request
    ...
    String  version();                                              // Version of smartClient
    */
//___________________________________________________________________________________________________________________________________
            URL*            _URL;                       // -> URL data structure
    protected:

        void                _parseURL(const string&);
